...
def chi_upup_pp(wb,wf,wf1):
    if (wf == wb-wf1-1):
        return re_2pgf_upup_pp(wb,wf,wf1)+1j*im_2pgf_upup_pp(wb,wf,wf1)+beta*(G(wf)*G(wf1))
    else:
        return re_2pgf_upup_pp(wb,wf,wf1)+1j*im_2pgf_upup_pp(wb,wf,wf1)

def chi_updo_pp(wb,wf,wf1):
    if (wf == wb-wf1-1):
        return re_2pgf_updo_pp(wb,wf,wf1)+1j*im_2pgf_updo_pp(wb,wf,wf1)+beta*(G(wf)*G(wf1))
    else:
