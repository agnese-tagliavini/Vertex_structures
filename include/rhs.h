...
class rhs_t 		///< Functor to specify the rhs calculation for both the self-energy and the vertex
{
   public:
      ...
      static dcomplex eval_diag_chi_pp( const idx_chi_t& idx, const state_t& state_vec, const gf_1p_mat_t& Gvec, double Lam );		///< Calculate particle-particle diagram for the flow
      static dcomplex eval_diag_chi_ph( const idx_chi_t& idx, const state_t& state_vec, const gf_1p_mat_t& Gvec, double Lam );		///< Calculate particle-hole diagram for the flow
      static dcomplex eval_diag_chi_xph( const idx_chi_t& idx, const state_t& state_vec, const gf_1p_mat_t& Gvec, double Lam );		///< Calculate particle-hole diagram for the flow
      
      static dcomplex eval_diag_P_pp( const idx_P_t& idx, const state_t& state_vec, const gf_1p_mat_t& Gvec, double Lam );		///< Calculate particle-particle diagram for the flow
      static dcomplex eval_diag_P_ph( const idx_P_t& idx, const state_t& state_vec, const gf_1p_mat_t& Gvec, double Lam );		///< Calculate particle-hole diagram for the flow
      static dcomplex eval_diag_P_xph( const idx_P_t& idx, const state_t& state_vec, const gf_1p_mat_t& Gvec, double Lam );		///< Calculate particle-hole diagram for the flow
