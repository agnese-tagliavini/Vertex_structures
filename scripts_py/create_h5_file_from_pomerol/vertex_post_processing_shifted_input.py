...
if ('/home/agnese/Coding/Vertex_structures/dat/H5FILES/BETA50/4SITES/U1/PREPROC/U'+ str(U)+'_BETA_'+ str(BETA)+'_FFREQ_'+ str(FFREQ)+'_BFREQ_' + str(BFREQ)+'.h5'):
    os.system('rm -r /home/agnese/Coding/Vertex_structures/dat/H5FILES/BETA50/4SITES/U1/PREPROC/U_'+ str(U)+'_BETA_'+ str(BETA)+'_FFREQ_'+ str(FFREQ)+'_BFREQ_' + str(BFREQ)+'.h5')

f = h5py.File('/home/agnese/Coding/Vertex_structures/dat/H5FILES/BETA50/4SITES/U1/PREPROC/U_'+ str(U)+'_BETA_'+ str(BETA)+'_FFREQ_'+ str(FFREQ)+'_BFREQ_' + str(BFREQ)+'.h5', 'w')   # Create the datafile.h5
