...
fname18 = "../../dat/H5FILES/BETA50/4SITES/U1/POSTPROC/dat_U1_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm_W0_ED.h5"
...
fname17b = "../../dat/H5FILES/BETA50/4SITES/U1/POSTPROC/dat_U1_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNT_W20_CORR_ED.h5"
fname18b = "../../dat/H5FILES/BETA50/4SITES/U1/POSTPROC/dat_U1_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm_W20_ED.h5"
fname19b = "../../dat/H5FILES/BETA50/4SITES/U1/POSTPROC/dat_U1_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm20_W20_CORR_ED.h5"
fname20b = "../../dat/H5FILES/BETA50/4SITES/U1/POSTPROC/dat_U1_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm20_W20_ED.h5"
fname21b = "../../dat/H5FILES/BETA50/4SITES/U1/POSTPROC/dat_U1_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm40_W20_CORR_ED.h5"
fname22b = "../../dat/H5FILES/BETA50/4SITES/U1/POSTPROC/dat_U1_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm40_W20_ED.h5"

#fname1 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNT_ASYR10xINVR_CORR_ED.h5"
#fname2 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNT_ED.h5"
#fname3 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNTm5_ASYR10xINVR_CORR_ED.h5"
#fname4 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm5_ED.h5"
#fname5 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNTm10_ASYR10xINVR_CORR_ED.h5"
#fname6 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm10_ED.h5"
#fname7 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNTm15_ASYR10xINVR_CORR_ED.h5"
#fname8 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm15_ED.h5"
#fname9 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNTm20_ASYR10xINVR_CORR_ED.h5"
#fname10 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm20_ED.h5"
#fname11 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNTm30_ASYR10xINVR_CORR_ED.h5"
#fname12 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm30_ED.h5"
#fname13 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNTm40_ASYR10xINVR_CORR_ED.h5"
#fname14 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm40_ED.h5"
#fname15 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH1_INVR1xCOUNTm50_ASYR10xINVR_CORR_ED.h5"
#fname16 = "../../dat/dat_U1p75_Beta50_PFCB1000_PARQ_SU2_METH2_INVR1xCOUNTm50_ED.h5"
...
def plotgamma_axis( use_pl, arr1, arr2, arr3, arr4, arr5, arr6, arr7, arr8, arr9, arr10, arr11, string ):
    zarr0 = np.array([ arr0[shift, n+fdimo20-fdim_min/2,fdimo20,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr1 = np.array([ arr1[shift + (bdim1-1)/2,n+fdimo21-fdim_min/2,fdimo21,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr2 = np.array([ arr2[shift + (bdim3-1)/2,n+fdimo23-fdim_min/2,fdimo23,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr3 = np.array([ arr3[shift + (bdim5-1)/2,n+fdimo25-fdim_min/2,fdimo25,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr4 = np.array([ arr4[shift + (bdim7-1)/2,n+fdimo27-fdim_min/2,fdimo27,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr5 = np.array([ arr5[shift + (bdim9-1)/2,n+fdimo29-fdim_min/2,fdimo29,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr6 = np.array([ arr6[shift + (bdim11-1)/2,n+fdimo211-fdim_min/2,fdimo211,0,0,0,0,0,0,0] for n in range(fdim_min)])
    pl.plot( gammagrid_plot, zarr0, marker = 'o', linestyle='--', color='k', ms=4, mew=0.4, label=r"INVR120")
    pl.plot( gammagrid_plot, zarr1, marker = 'o', linestyle='-', color='r', ms=3, mew=0.2, label=r"INVR=60")
    pl.plot( gammagrid_plot, zarr2, marker = 'x', linestyle='-', color='b', ms=3, mew=0.2, label=r"INVR=55")
    pl.plot( gammagrid_plot, zarr3, marker = '^', linestyle='-', color='g', ms=3, mew=0.2, label=r"INVR=50")
    pl.plot( gammagrid_plot, zarr4, marker = 'd', linestyle='-', color='c', ms=3, mew=0.2, label=r"INVR=45")
    pl.plot( gammagrid_plot, zarr5, marker = 's', linestyle='-', color='m', ms=3, mew=0.2, label=r"INVR=40")
    pl.plot( gammagrid_plot, zarr6, marker = '<', linestyle='-', color='k', ms=3, mew=0.2, label=r"INVR=30")
...
def plotgamma_diag1( use_pl, arr1, arr2, arr3, arr4, arr5, arr6, arr7, arr8, arr9, arr10, arr11, string ):
    zarr1 = np.array([ arr1[shift, n+fdimo217-fdim_min/2,n+fdimo17-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr2 = np.array([ arr2[shift, n+fdimo219-fdim_min/2,n+fdimo19-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr3 = np.array([ arr3[shift, n+fdimo221-fdim_min/2,n+fdimo21-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr4 = np.array([ arr4[shift + (bdim1-1)/2,n+fdimo21-fdim_min/2,n+fdimo21-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr5 = np.array([ arr5[shift + (bdim3-1)/2,n+fdimo23-fdim_min/2,n+fdimo23-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr6 = np.array([ arr6[shift + (bdim5-1)/2,n+fdimo25-fdim_min/2,n+fdimo25-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr7 = np.array([ arr7[shift + (bdim7-1)/2,n+fdimo27-fdim_min/2,n+fdimo27-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr8 = np.array([ arr8[shift + (bdim9-1)/2,n+fdimo29-fdim_min/2,n+fdimo29-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr9 = np.array([ arr9[shift + (bdim11-1)/2,n+fdimo211-fdim_min/2,n+fdimo211-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr10 = np.array([ arr10[shift + (bdim13-1)/2,n+fdimo213-fdim_min/2,n+fdimo213-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr11 = np.array([ arr11[shift + (bdim15-1)/2,n+fdimo215-fdim_min/2,n+fdimo215-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    pl.plot( gammagrid_plot, zarr1, marker = 'o', linestyle='-', color='r', ms=3, mew=0.2, label=r"INVR=60")
    pl.plot( gammagrid_plot, zarr2, marker = 'x', linestyle='-', color='b', ms=3, mew=0.2, label=r"INVR=55")
    pl.plot( gammagrid_plot, zarr3, marker = '^', linestyle='-', color='g', ms=3, mew=0.2, label=r"INVR=50")
    pl.plot( gammagrid_plot, zarr4, marker = 'd', linestyle='-', color='c', ms=3, mew=0.2, label=r"INVR=45")
...
#
##pl.suptitle(r"$U=$" + str(UINT) + r"     $\beta=$" + str(BETA) + r"     $\epsilon=$" + str(EPS) +  r"     $\Omega=$" + str(shift) + r"$*2\pi/\beta$")
#plotgamma_axis( pl.subplot(2,2,1), regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 + regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 + regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 + regamma_pp7[:,:,::-1,:,:,:,:,:,:,:],regamma_pp9 + regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 + regamma_pp11[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu, \nu'=0, \omega =20}_{s}$" ) # flip sign of w_out
#pl.xlabel(r"$\nu$")
#plotgamma_axis( pl.subplot(2,2,2), regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 - regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 - regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 - regamma_pp7[:,:,::-1,:,:,:,:,:,:,:], regamma_pp9 - regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 - regamma_pp11[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu, \nu'=0, \omega =20}_{t}$" ) # flip sign of w_out
#pl.xlabel(r"$\nu$")
#plotgamma_axis( pl.subplot(2,2,3), 2*regamma_ph1 - regamma_xph1, 2*regamma_ph3 - regamma_xph3, 2*regamma_ph5 - regamma_xph5, 2*regamma_ph7 - regamma_xph7,2*regamma_ph9 - regamma_xph9,2*regamma_ph11 - regamma_xph11, RE + r"\Gamma^{\nu, \nu'=0, \omega =20}_{d}$" )
#pl.xlabel(r"$\nu$")
#plotgamma_axis( pl.subplot(2,2,4), - regamma_xph1, - regamma_xph3, - regamma_xph5, - regamma_xph7,- regamma_xph9,- regamma_xph11, RE + r"\Gamma^{\nu, \nu'=0, \omega =20}_{m}$" )
#pl.xlabel(r"$\nu$")
#
#
#pl.tight_layout()
...
#pl.suptitle(r"$U=$" + str(UINT) + r"     $\beta=$" + str(BETA) + r"     $\epsilon=$" + str(EPS) +  r"     $\Omega=$" + str(shift) + r"$*2\pi/\beta$")
plotgamma_diag1( pl.subplot(2,2,1), regamma_pp0 + regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 + regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 + regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 + regamma_pp7[:,:,::-1,:,:,:,:,:,:,:],regamma_pp9 + regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 + regamma_pp11[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu=\nu', \omega =0}_{s}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,2), regamma_pp0 - regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 - regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 - regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 - regamma_pp7[:,:,::-1,:,:,:,:,:,:,:], regamma_pp9 - regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 - regamma_pp11[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu=\nu', \omega =0}_{t}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,3), 2*regamma_ph0 - regamma_xph0,2*regamma_ph1 - regamma_xph1, 2*regamma_ph3 - regamma_xph3, 2*regamma_ph5 - regamma_xph5, 2*regamma_ph7 - regamma_xph7,2*regamma_ph9 - regamma_xph9,2*regamma_ph11 - regamma_xph11, RE + r"\Gamma^{\nu=\nu', \omega =0}_{d}$" )
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,4), - regamma_xph0,- regamma_xph1, - regamma_xph3, - regamma_xph5, - regamma_xph7,- regamma_xph9,- regamma_xph11, RE + r"\Gamma^{\nu=\nu', \omega =0}_{m}$" )
pl.xlabel(r"$\nu$")

pl.tight_layout()

#--- Save to file
pl.savefig("plots/Gammas_exactcomp_METHOD2_nu=nu'.png", dpi = 150)
...
#
##pl.suptitle(r"$U=$" + str(UINT) + r"     $\beta=$" + str(BETA) + r"     $\epsilon=$" + str(EPS) +  r"     $\Omega=$" + str(shift) + r"$*2\pi/\beta$")
#plotgamma_diag1( pl.subplot(2,2,1), regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 + regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 + regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 + regamma_pp7[:,:,::-1,:,:,:,:,:,:,:],regamma_pp9 + regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 + regamma_pp11[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu=\nu', \omega =20}_{s}$" ) # flip sign of w_out
#pl.xlabel(r"$\nu$")
#plotgamma_diag1( pl.subplot(2,2,2), regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 - regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 - regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 - regamma_pp7[:,:,::-1,:,:,:,:,:,:,:], regamma_pp9 - regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 - regamma_pp11[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu=\nu', \omega =20}_{t}$" ) # flip sign of w_out
#pl.xlabel(r"$\nu$")
#plotgamma_diag1( pl.subplot(2,2,3), 2*regamma_ph1 - regamma_xph1, 2*regamma_ph3 - regamma_xph3, 2*regamma_ph5 - regamma_xph5, 2*regamma_ph7 - regamma_xph7,2*regamma_ph9 - regamma_xph9,2*regamma_ph11 - regamma_xph11, RE + r"\Gamma^{\nu=\nu', \omega =20}_{d}$" )
#pl.xlabel(r"$\nu$")
#plotgamma_diag1( pl.subplot(2,2,4), - regamma_xph1, - regamma_xph3, - regamma_xph5, - regamma_xph7,- regamma_xph9,- regamma_xph11, RE + r"\Gamma^{\nu=\nu', \omega =20}_{m}$" )
#pl.xlabel(r"$\nu$")
#
#
#
...
shift= 0
def plotgamma_axis( use_pl, arr0, arr1, arr2, string ):
    zarr0 = np.array([ arr0[shift, n+fdimo20-fdim_min/2,fdimo20,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr1 = np.array([ arr1[shift + (bdim1-1)/2,n+fdimo21-fdim_min/2,fdimo21,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr2 = np.array([ arr2[shift + (bdim2-1)/2,n+fdimo22-fdim_min/2,fdimo22,0,0,0,0,0,0,0] for n in range(fdim_min)])
    pl.plot( gammagrid_plot, zarr0, marker = 'o', linestyle='--', color='k', ms=3, mew=0.2, label=r"INVR=120")
    pl.plot( gammagrid_plot, zarr1, marker = 'o', linestyle='-', color='r', ms=3, mew=0.2, label=r"INVR=60 CORR")
...
def plotgamma_diag1( use_pl, arr0, arr1, arr2, string ):
    zarr0 = np.array([ arr0[shift, n+fdimo20-fdim_min/2,n+fdimo20-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
...
plotgamma_axis( pl.subplot(2,2,1), regamma_pp0 + regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 + regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{s}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_axis( pl.subplot(2,2,2), regamma_pp0 - regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 - regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{t}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_axis( pl.subplot(2,2,3), 2*regamma_ph0 - regamma_xph0,2*regamma_ph1 - regamma_xph1, 2*regamma_ph2 - regamma_xph2,  RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{d}$" )
pl.xlabel(r"$\nu$")
plotgamma_axis( pl.subplot(2,2,4), - regamma_xph0,- regamma_xph1, - regamma_xph2, RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{m}$" )
pl.xlabel(r"$\nu$")

pl.tight_layout()

#--- Save to file
pl.savefig("plots/Comparison_EXACTINV_CORR_NOCORR_Gammas_METHOD2_axis_nu'=0.png", dpi = 150)
#pl.savefig("plots/Gammas_METHOD1_axis_nu'=0.png", dpi = 150)
pl.figure(dpi=100) # Reset dpi to default
pl.clf()

plotgamma_diag1( pl.subplot(2,2,1), regamma_pp0 + regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 + regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu=\nu', \omega =0}_{s}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,2), regamma_pp0 - regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 - regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu= \nu', \omega =0}_{t}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,3), 2*regamma_ph0 - regamma_xph0,2*regamma_ph1 - regamma_xph1, 2*regamma_ph2 - regamma_xph2,  RE + r"\Gamma^{\nu=\nu', \omega =0}_{d}$" )
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,4), - regamma_xph0,- regamma_xph1, - regamma_xph2, RE + r"\Gamma^{\nu=\nu', \omega =0}_{m}$" )
pl.xlabel(r"$\nu$")

pl.tight_layout()

#--- Save to file
pl.savefig("plots/Comparison_EXACTINV_CORR_NOCORR_Gammas_METHOD2_axis_nu=nu'.png", dpi = 150)
#pl.savefig("plots/Gammas_METHOD1_axis_nu'=0.png", dpi = 150)
pl.figure(dpi=100) # Reset dpi to default
pl.clf()
...
def plotgamma_axis( use_pl, arr0, arr1, arr2, string ):
    ...
    zarr2 = np.array([ arr2[shift + (bdim2-1)/2,n+fdimo22-fdim_min/2,fdimo22,0,0,0,0,0,0,0]-arr0[shift, n+fdimo20-fdim_min/2,fdimo20,0,0,0,0,0,0,0] for n in range(fdim_min)])
    pl.plot( gammagrid_plot, zarr0, marker = 'o', linestyle='--', color='k', ms=3, mew=0.2, label=r"$0$")
    pl.plot( gammagrid_plot, zarr1, marker = 'o', linestyle='-', color='r', ms=3, mew=0.2, label=r"INV CORR-EXACT")
    pl.plot( gammagrid_plot, zarr2, marker = 'x', linestyle='-', color='b', ms=3, mew=0.2, label=r"INV NOCORR-EXACT")
    #pl.xlim([0.3*min(gammagrid_plot),0.3*max(gammagrid_plot)])
    use_pl.set_title( string , fontsize=10 )
    pl.legend(prop={'size':5})
...
def plotgamma_diag1( use_pl, arr0, arr1, arr2, string ):
    ...
    zarr2 = np.array([ arr2[shift + (bdim2-1)/2,n+fdimo22-fdim_min/2,n+fdimo22-fdim_min/2,0,0,0,0,0,0,0]-arr0[shift, n+fdimo20-fdim_min/2,n+fdimo20-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    pl.plot( gammagrid_plot, zarr0, marker = 'o', linestyle='--', color='k', ms=3, mew=0.2, label=r"$0$")
    pl.plot( gammagrid_plot, zarr1, marker = 'o', linestyle='-', color='r', ms=3, mew=0.2, label=r"INV CORR-EXACT")
    pl.plot( gammagrid_plot, zarr2, marker = 'x', linestyle='-', color='b', ms=3, mew=0.2, label=r"INV NOCORR-EXACT")
    #pl.xlim([min(gammagrid_plot),max(gammagrid_plot)])
...
plotgamma_axis( pl.subplot(2,2,1), regamma_pp0 + regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 + regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\delta \Gamma^{\nu, \nu'=0, \omega =0}_{s}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_axis( pl.subplot(2,2,2), regamma_pp0 - regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 - regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\delta \Gamma^{\nu, \nu'=0, \omega =0}_{t}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_axis( pl.subplot(2,2,3), 2*regamma_ph0 - regamma_xph0,2*regamma_ph1 - regamma_xph1, 2*regamma_ph2 - regamma_xph2,  RE + r"\delta \Gamma^{\nu, \nu'=0, \omega =0}_{d}$" )
pl.xlabel(r"$\nu$")
plotgamma_axis( pl.subplot(2,2,4), - regamma_xph0,- regamma_xph1, - regamma_xph2, RE + r"\delta \Gamma^{\nu, \nu'=0, \omega =0}_{m}$" )
pl.xlabel(r"$\nu$")

pl.tight_layout()

#--- Save to file
pl.savefig("plots/Delta_EXACTINV_CORR_NOCORR_Gammas_METHOD2_axis_nu'=0.png", dpi = 150)
#pl.savefig("plots/Gammas_METHOD1_axis_nu'=0.png", dpi = 150)
pl.figure(dpi=100) # Reset dpi to default
pl.clf()

plotgamma_diag1( pl.subplot(2,2,1), regamma_pp0 + regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 + regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\delta \Gamma^{\nu=\nu', \omega =0}_{s}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,2), regamma_pp0 - regamma_pp0[:,:,::-1,:,:,:,:,:,:,:],regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp2 - regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], RE + r"\delta \Gamma^{\nu= \nu', \omega =0}_{t}$" ) # flip sign of w_out
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,3), 2*regamma_ph0 - regamma_xph0,2*regamma_ph1 - regamma_xph1, 2*regamma_ph2 - regamma_xph2,  RE + r"\delta \Gamma^{\nu=\nu', \omega =0}_{d}$" )
pl.xlabel(r"$\nu$")
plotgamma_diag1( pl.subplot(2,2,4), - regamma_xph0,- regamma_xph1, - regamma_xph2, RE + r"\delta \Gamma^{\nu=\nu', \omega =0}_{m}$" )
pl.xlabel(r"$\nu$")

pl.tight_layout()

#--- Save to file
pl.savefig("plots/Delta_EXACTINV_CORR_NOCORR_Gammas_METHOD2_axis_nu=nu'.png", dpi = 150)
#pl.savefig("plots/Gammas_METHOD1_axis_nu'=0.png", dpi = 150)
pl.figure(dpi=100) # Reset dpi to default
pl.clf()
...
#--- INVR = COUNT 
diff_regamma_pp1 = vert_mul * np.subtract( f2["/gamma_func/RE_PP"], f1["/gamma_func/RE_PP"])
diff_imgamma_pp1 = vert_mul * np.subtract( f2["/gamma_func/IM_PP"], f1["/gamma_func/IM_PP"] )
diff_regamma_ph1 = vert_mul * np.subtract( f2["/gamma_func/RE_PH"], f1["/gamma_func/RE_PH"] )
diff_imgamma_ph1 = vert_mul * np.subtract( f2["/gamma_func/IM_PH"], f1["/gamma_func/IM_PH"] )
diff_regamma_xph1 = vert_mul * np.subtract(f2["/gamma_func/RE_XPH"],f1["/gamma_func/RE_XPH"])
diff_imgamma_xph1 = vert_mul * np.subtract(f2["/gamma_func/IM_XPH"],f1["/gamma_func/IM_XPH"])

#--- INVR=COUNT-5
diff_regamma_pp2 = vert_mul * np.subtract( f4["/gamma_func/RE_PP"], f3["/gamma_func/RE_PP"])
diff_imgamma_pp2 = vert_mul * np.subtract( f4["/gamma_func/IM_PP"], f3["/gamma_func/IM_PP"] )
diff_regamma_ph2 = vert_mul * np.subtract( f4["/gamma_func/RE_PH"], f3["/gamma_func/RE_PH"] )
diff_imgamma_ph2 = vert_mul * np.subtract( f4["/gamma_func/IM_PH"], f3["/gamma_func/IM_PH"] )
diff_regamma_xph2 = vert_mul * np.subtract(f4["/gamma_func/RE_XPH"],f3["/gamma_func/RE_XPH"])
diff_imgamma_xph2 = vert_mul * np.subtract(f4["/gamma_func/IM_XPH"],f3["/gamma_func/IM_XPH"])

#--- INVR=COUNT-10
diff_regamma_pp3 = vert_mul * np.subtract( f6["/gamma_func/RE_PP"], f5["/gamma_func/RE_PP"])
diff_imgamma_pp3 = vert_mul * np.subtract( f6["/gamma_func/IM_PP"], f5["/gamma_func/IM_PP"] )
diff_regamma_ph3 = vert_mul * np.subtract( f6["/gamma_func/RE_PH"], f5["/gamma_func/RE_PH"] )
diff_imgamma_ph3 = vert_mul * np.subtract( f6["/gamma_func/IM_PH"], f5["/gamma_func/IM_PH"] )
diff_regamma_xph3 = vert_mul * np.subtract(f6["/gamma_func/RE_XPH"],f5["/gamma_func/RE_XPH"])
diff_imgamma_xph3 = vert_mul * np.subtract(f6["/gamma_func/IM_XPH"],f5["/gamma_func/IM_XPH"])

#--- INVR=COUNT-15
diff_regamma_pp4 = vert_mul * np.subtract( f8["/gamma_func/RE_PP"], f7["/gamma_func/RE_PP"])
diff_imgamma_pp4 = vert_mul * np.subtract( f8["/gamma_func/IM_PP"], f7["/gamma_func/IM_PP"] )
diff_regamma_ph4 = vert_mul * np.subtract( f8["/gamma_func/RE_PH"], f7["/gamma_func/RE_PH"] )
diff_imgamma_ph4 = vert_mul * np.subtract( f8["/gamma_func/IM_PH"], f7["/gamma_func/IM_PH"] )
diff_regamma_xph4 = vert_mul * np.subtract(f8["/gamma_func/RE_XPH"],f7["/gamma_func/RE_XPH"])
diff_imgamma_xph4 = vert_mul * np.subtract(f8["/gamma_func/IM_XPH"],f7["/gamma_func/IM_XPH"])

#--- INVR=COUNT-20
diff_regamma_pp5 = vert_mul * np.subtract( f10["/gamma_func/RE_PP"], f9["/gamma_func/RE_PP"])
diff_imgamma_pp5 = vert_mul * np.subtract( f10["/gamma_func/IM_PP"], f9["/gamma_func/IM_PP"] )
diff_regamma_ph5 = vert_mul * np.subtract( f10["/gamma_func/RE_PH"], f9["/gamma_func/RE_PH"] )
diff_imgamma_ph5 = vert_mul * np.subtract( f10["/gamma_func/IM_PH"], f9["/gamma_func/IM_PH"] )
diff_regamma_xph5 = vert_mul * np.subtract(f10["/gamma_func/RE_XPH"],f9["/gamma_func/RE_XPH"])
diff_imgamma_xph5 = vert_mul * np.subtract(f10["/gamma_func/IM_XPH"],f9["/gamma_func/IM_XPH"])
#--- INVR=COUNT-30
diff_regamma_pp6 = vert_mul * np.subtract( f12["/gamma_func/RE_PP"], f11["/gamma_func/RE_PP"])
diff_imgamma_pp6 = vert_mul * np.subtract( f12["/gamma_func/IM_PP"], f11["/gamma_func/IM_PP"] )
diff_regamma_ph6 = vert_mul * np.subtract( f12["/gamma_func/RE_PH"], f11["/gamma_func/RE_PH"] )
diff_imgamma_ph6 = vert_mul * np.subtract( f12["/gamma_func/IM_PH"], f11["/gamma_func/IM_PH"] )
diff_regamma_xph6 = vert_mul * np.subtract(f12["/gamma_func/RE_XPH"],f11["/gamma_func/RE_XPH"])
diff_imgamma_xph6 = vert_mul * np.subtract(f12["/gamma_func/IM_XPH"],f11["/gamma_func/IM_XPH"])
...
def plotgamma_diag1( use_pl, arr1, arr2, arr3, arr4, arr5, arr6, string ):
    zarr1 = np.array([ arr1[shift + (bdim1-1)/2,n+fdimo21-fdim_min/2,n+fdimo21-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr2 = np.array([ arr2[shift + (bdim3-1)/2,n+fdimo23-fdim_min/2,n+fdimo23-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr3 = np.array([ arr3[shift + (bdim5-1)/2,n+fdimo25-fdim_min/2,n+fdimo25-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr4 = np.array([ arr4[shift + (bdim7-1)/2,n+fdimo27-fdim_min/2,n+fdimo27-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr5 = np.array([ arr5[shift + (bdim9-1)/2,n+fdimo29-fdim_min/2,n+fdimo29-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    zarr6 = np.array([ arr6[shift + (bdim11-1)/2,n+fdimo211-fdim_min/2,n+fdimo211-fdim_min/2,0,0,0,0,0,0,0] for n in range(fdim_min)])
    pl.plot( gammagrid_plot, zarr1, marker = 'o', linestyle='-', color='r', ms=3, mew=0.2, label=r"INVR=60")
    pl.plot( gammagrid_plot, zarr2, marker = 'x', linestyle='-', color='b', ms=3, mew=0.2, label=r"INVR=55")
    pl.plot( gammagrid_plot, zarr3, marker = '^', linestyle='-', color='g', ms=3, mew=0.2, label=r"INVR=50")
    pl.plot( gammagrid_plot, zarr4, marker = 'd', linestyle='-', color='c', ms=3, mew=0.2, label=r"INVR=45")
...
#INVROVR=[1,2,4]
INVROVR=[10,20,30,40,45,50,55,60]

#---  Helper functions (include translation from  nambu to physical CAUTION : USING TIME REVERSAL SYMM) 
def plotgamma_conv_axis( use_pl, arr1, arr2, arr3, arr4, arr5, arr6,arr7,arr8,string ):
    zarr = [ arr8[shift + (bdim15-1)/2,fdimo215,fdimo215,0,0,0,0,0,0,0], arr7[shift + (bdim13-1)/2,fdimo213,fdimo213,0,0,0,0,0,0,0],arr6[shift + (bdim11-1)/2,fdimo211,fdimo211,0,0,0,0,0,0,0],arr5[shift + (bdim9-1)/2,fdimo29,fdimo29,0,0,0,0,0,0,0], arr4[shift + (bdim7-1)/2,fdimo27,fdimo27,0,0,0,0,0,0,0], arr3[shift + (bdim5-1)/2,fdimo25,fdimo25,0,0,0,0,0,0,0], arr2[shift + (bdim3-1)/2,fdimo23,fdimo23,0,0,0,0,0,0,0], arr1[shift + (bdim1-1)/2,fdimo21,fdimo21,0,0,0,0,0,0,0]]
...
plotgamma_conv_axis( pl.subplot(2,2,1), regamma_pp1 + regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 + regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 + regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 + regamma_pp7[:,:,::-1,:,:,:,:,:,:,:],regamma_pp9 + regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 + regamma_pp11[:,:,::-1,:,:,:,:,:,:,:], regamma_pp13 + regamma_pp13[:,:,::-1,:,:,:,:,:,:,:],regamma_pp15 + regamma_pp15[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{0, 0, \omega =0}_{s}$" ) # flip sign of w_out
pl.xlabel(r"$INVR$")
plotgamma_conv_axis( pl.subplot(2,2,2), regamma_pp1 - regamma_pp1[:,:,::-1,:,:,:,:,:,:,:], regamma_pp3 - regamma_pp3[:,:,::-1,:,:,:,:,:,:,:], regamma_pp5 - regamma_pp5[:,:,::-1,:,:,:,:,:,:,:], regamma_pp7 - regamma_pp7[:,:,::-1,:,:,:,:,:,:,:], regamma_pp9 - regamma_pp9[:,:,::-1,:,:,:,:,:,:,:],regamma_pp11 - regamma_pp11[:,:,::-1,:,:,:,:,:,:,:],regamma_pp13 - regamma_pp13[:,:,::-1,:,:,:,:,:,:,:],regamma_pp15 - regamma_pp15[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{t}$" ) # flip sign of w_out
pl.xlabel(r"$INVR$")
plotgamma_conv_axis( pl.subplot(2,2,3), 2*regamma_ph1 - regamma_xph1, 2*regamma_ph3 - regamma_xph3, 2*regamma_ph5 - regamma_xph5, 2*regamma_ph7 - regamma_xph7,2*regamma_ph9 - regamma_xph9,2*regamma_ph11 - regamma_xph11,2*regamma_ph13 - regamma_xph13,2*regamma_ph15 - regamma_xph15, RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{d}$" )
pl.xlabel(r"$INVR$")
plotgamma_conv_axis( pl.subplot(2,2,4), - regamma_xph1, - regamma_xph3, - regamma_xph5, - regamma_xph7,- regamma_xph9,- regamma_xph11,- regamma_xph13,- regamma_xph15, RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{m}$" )
pl.xlabel(r"$INVR$")

pl.tight_layout()

#--- Save to file
pl.savefig("plots/Gammas_METHOD2_conv.png", dpi = 150)
...
#--- Save to file
pl.savefig("plots/Gammas_METHOD2_Om="+str(shift)+"_conv.png", dpi = 150)
...
plotgamma_conv_axis( pl.subplot(2,2,1), regamma_pp2 + regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], regamma_pp4 + regamma_pp4[:,:,::-1,:,:,:,:,:,:,:], regamma_pp6 + regamma_pp6[:,:,::-1,:,:,:,:,:,:,:], regamma_pp8 + regamma_pp8[:,:,::-1,:,:,:,:,:,:,:],regamma_pp10 + regamma_pp10[:,:,::-1,:,:,:,:,:,:,:],regamma_pp12 + regamma_pp12[:,:,::-1,:,:,:,:,:,:,:], regamma_pp14 + regamma_pp14[:,:,::-1,:,:,:,:,:,:,:],regamma_pp16 + regamma_pp16[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{0, 0, \omega =0}_{s}$" ) # flip sign of w_out
pl.xlabel(r"$INVR$")
plotgamma_conv_axis( pl.subplot(2,2,2), regamma_pp2 - regamma_pp2[:,:,::-1,:,:,:,:,:,:,:], regamma_pp4 - regamma_pp4[:,:,::-1,:,:,:,:,:,:,:], regamma_pp6 - regamma_pp6[:,:,::-1,:,:,:,:,:,:,:], regamma_pp8 - regamma_pp8[:,:,::-1,:,:,:,:,:,:,:], regamma_pp10 - regamma_pp10[:,:,::-1,:,:,:,:,:,:,:],regamma_pp12 - regamma_pp12[:,:,::-1,:,:,:,:,:,:,:],regamma_pp14 - regamma_pp14[:,:,::-1,:,:,:,:,:,:,:],regamma_pp16 - regamma_pp16[:,:,::-1,:,:,:,:,:,:,:], RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{t}$" ) # flip sign of w_out
pl.xlabel(r"$INVR$")
plotgamma_conv_axis( pl.subplot(2,2,3), 2*regamma_ph2 - regamma_xph2, 2*regamma_ph4 - regamma_xph4, 2*regamma_ph6 - regamma_xph6, 2*regamma_ph8 - regamma_xph8,2*regamma_ph10 - regamma_xph10,2*regamma_ph12 - regamma_xph12,2*regamma_ph14 - regamma_xph14,2*regamma_ph16 - regamma_xph16, RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{d}$" )
pl.xlabel(r"$INVR$")
plotgamma_conv_axis( pl.subplot(2,2,4), - regamma_xph2, - regamma_xph4, - regamma_xph6, - regamma_xph8,- regamma_xph10,- regamma_xph12,- regamma_xph14,- regamma_xph16, RE + r"\Gamma^{\nu, \nu'=0, \omega =0}_{m}$" )
pl.xlabel(r"$INVR$")

pl.tight_layout()

#--- Save to file
pl.savefig("plots/Gammas_METHOD2_conv_NOCORR.png", dpi = 150)
#pl.savefig("plots/Gammas_METHOD1_conv_NOCORR.png", dpi = 150)
pl.figure(dpi=100) # Reset dpi to default
pl.clf()
...
#--- Save to file
pl.savefig("plots/Gammas_METHOD2_Om="+str(shift)+"_conv_NOCORR.png", dpi = 150)
#pl.savefig("plots/Gammas_METHOD1_Om="+str(shift)+"_conv_NOCORR.png", dpi = 150)
pl.figure(dpi=100) # Reset dpi to default
pl.clf()
